...
import json
import unittest
import plugins.reverseimage as reverseimage
import tgapi

class TestPick(unittest.TestCase):
    def test_reverseimage(self):
        tg = tgapi.TelegramApi
        fullMessageText = '/reverseimage http://i493.photobucket.com/albums/rr292/ReidxCore/PlainSwirl.jpg'
